...
@Component
public class ObserverCommandHandler implements CommandHandler {
    @Autowired
    ...
    public SendMessage handleMessage(Message message) {
        ...
        List<Task> tasks = trackerService.getObservedTasksForUser(
                message.getFrom().getUserName());
        String responseText = "Задачи, в которых Вы наблюдатель:\n" + TextUtils.getTaskListAsText(tasks);
    ...
    public CommandType getMessageType() {
        return CommandType.GET_MY_TASKS_AS_OBSERVER;
    }
}
