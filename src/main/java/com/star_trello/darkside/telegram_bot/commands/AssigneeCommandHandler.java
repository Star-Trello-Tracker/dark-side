...
@Component
public class AssigneeCommandHandler implements CommandHandler {
    @Autowired
    ...
    public SendMessage handleMessage(Message message) {
        ...
        List<Task> tasks = trackerService.getAssignedTasksForUser(
                message.getFrom().getUserName());
        String responseText = "Задачи, в которых Вы исполнитель:\n" + TextUtils.getTaskListAsText(tasks);
    ...
    public CommandType getMessageType() {
        return CommandType.GET_MY_TASKS_AS_ASSIGNEE;
    }
}
